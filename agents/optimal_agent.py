    ...
    def _update_system_prompt(self):
        ...
        lang_info = {
            ...
            'java': {
                ...
                'ext': 'java',
                'note': 'IMPORTANT: The class name must match the filename (without .java extension). For example, if the file is "optimal.java", the class must be named "optimal".'
            },
            'cpp': {
                'name': 'C++',
        ...
        self.system_prompt = f"""You are an expert competitive programmer.

Your task is to generate an EFFICIENT solution in {info['name']} that meets the time/space constraints.
